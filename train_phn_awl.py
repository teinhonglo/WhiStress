...
from whistress.model.model import WhiStress, WhiStressPhn
...
if __name__ == "__main__":
    ...
    for epoch in range(args.epochs):
        ...
        print(f"[Epoch {epoch+1}] - Train Loss: {total_loss / len(train_loader):.4f}, ML: {total_loss_main / len(train_loader):.4f}, AWL: {total_loss_awl / len(train_loader):.4f}, PL: {total_loss_phone / len(train_loader):.4f}")
